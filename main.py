...
st.markdown(
    """
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@100;100;100;100&display=swap');
    </style>
    """,
    unsafe_allow_html=True,
)
...
# The fill color is set to match the default text color from the theme.
